...
<body>	
	<form action="">
		<div> 
			<button id="reset" value="0"  style="left: 500px; position: absolute; top: 20px; width: 50px;">reset</button>
			<button class="people" value="1" style="left: 560px;">1</button>
			<button class="people" value="2" style="left: 590px;">2</button>
			<button class="people" value="3" style="left: 620px;">3</button>
			<button class="people" value="4" style="left: 650px;">4</button>
			<button class="people" value="5" style="left: 680px;">5</button>
		</div> 
		...
		<input type="button" value="Submit" id="submit" style="position: absolute; left:610px; top: 250px; width: 70px;" >
	</form>
</body>
</html>